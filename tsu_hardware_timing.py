...
class HardwarePerformanceEstimator:
    ...
    def estimate_sampling_time(self, n_samples: int, dimension: int, 
                              emulator_time: float) -> dict:
        """
        ...
        equilibration_time = (self.spec.equilibration_steps * 
                            self.spec.thermal_relaxation_time)
    ...
    def print_performance_report(self, n_samples: int, dimension: int,
        ...
        print(f"  Advantage:  {results['energy_comparison']['energy_advantage']:.0f}x more efficient")
