    ...
    def summary(self) -> Dict:
        ...
        if self.optimal_objective is not None:
            if abs(self.optimal_objective) > 1e-10:
                gaps = [(obj - self.optimal_objective) / abs(self.optimal_objective) * 100 
...
class OptimizationBenchmark:
    ...
    def benchmark_maxcut(self, n_nodes: int = 20,
                        edge_density: float = 0.5,
                        n_trials: int = 5,
                        n_steps: int = 1000) -> OptimizationResult:
        """
    ...
    def benchmark_graph_coloring(self, n_nodes: int = 15,
                                 n_colors: int = 3,
    ...
    def benchmark_number_partitioning(self, n_numbers: int = 20,
                                     n_trials: int = 5,
                                     n_steps: int = 1000) -> OptimizationResult:
        """
