...
class BenchmarkRunner:
    ...
    def _print_summary(self):
        ...
        for name, result in self.results["ml"].items():
            ...
            cov_str = (
                f"Cov={summary['95_coverage']['mean']:.0%}" if "95_coverage" in summary else ""
            )
...
def main():
    ...
    parser.add_argument(
        "--quick", action="store_true", help="Run quick benchmarks (reduced sample sizes)"
    )
    parser.add_argument("--seed", type=int, default=42, help="Random seed for reproducibility")
    parser.add_argument(
        "--output-dir", type=str, default="visual_output", help="Directory for saving results"
    )
