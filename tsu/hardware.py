...
class HardwarePerformanceEstimator:
    ...
    def print_performance_report(
        ...
        print("  (Running physics simulation on CPU)")
        ...
        energy_advantage = results["energy_comparison"]["energy_advantage"]
        print(f"  Advantage:  {energy_advantage:.0f}x more efficient")
...
class ConservativeEstimator:
    ...
    def estimate(self, n_samples: int, emulator_time: float) -> dict:
        ...
        # sequential_time = n_samples * equilibration_time  # For future use
...
def demo_honest_projections():
    ...
    estimator.print_performance_report(n_samples, dimension, emulator_time)
