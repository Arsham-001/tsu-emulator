...
class TestPosteriorSample:
    ...
    def test_creation(self):
        ...
        sample = PosteriorSample(weights=weights, bias=bias, energy=1.5, temperature=1.0)
...
class TestBayesianLinear:
    ...
    def test_temperature_scaling(self):
        ...
        samples_low_temp = [layer.sample_weights(temperature=0.1)[0] for _ in range(100)]
        samples_high_temp = [layer.sample_weights(temperature=10.0)[0] for _ in range(100)]
...
class TestBayesianNetwork:
    ...
    def test_training_reduces_loss(self):
        ...
        # Train
        history = net.fit(
            x_train, y_train, n_epochs=20, batch_size=32, learning_rate=0.01, verbose=False
        )
...
class TestBayesianRegressor:
    ...
    def test_active_learning_selection(self):
        ...
        selected = regressor.select_informative_samples(x_pool, n_select=5, n_samples=50)
    ...
    def test_training_on_sine_function(self):
        ...
        history = regressor.fit(
            x_train, y_train, n_epochs=30, batch_size=16, learning_rate=0.01, verbose=False
        )
