...
class TestPredictionsWithUncertainty:
    ...
    def test_basic_plot(self):
        ...
        fig = plot_predictions_with_uncertainty(x, y_pred, y_std, show=False)
    ...
    def test_with_true_values(self):
        ...
        fig = plot_predictions_with_uncertainty(x, y_pred, y_std, y_true=y_true, show=False)
    ...
    def test_with_training_data(self):
        ...
        fig = plot_predictions_with_uncertainty(
            x, y_pred, y_std, x_train=x_train, y_train=y_train, show=False
        )
    ...
    def test_multiple_confidence_levels(self):
        ...
        fig = plot_predictions_with_uncertainty(
            x, y_pred, y_std, confidence_levels=[1.0, 2.0, 3.0], show=False
        )
...
class TestUncertaintyVsError:
    ...
    def test_basic_calibration_plot(self):
        ...
        fig = plot_uncertainty_vs_error(y_true, y_pred, y_std, show=False)
    ...
    def test_different_bin_counts(self):
        ...
        for bins in [10, 20, 30]:
            fig = plot_uncertainty_vs_error(y_true, y_pred, y_std, bins=bins, show=False)
            assert isinstance(fig, Figure)
            plt.close(fig)
...
class TestEnergyLandscape:
    ...
    def test_simple_quadratic(self):
        ...
        fig = plot_energy_landscape_2d(
            energy, xlim=(-2, 2), ylim=(-2, 2), resolution=30, show=False
        )
    ...
    def test_with_samples(self):
        ...
        fig = plot_energy_landscape_2d(
            energy, xlim=(-2, 2), ylim=(-2, 2), samples=samples, resolution=30, show=False
        )
    ...
    def test_with_trajectory(self):
        ...
        trajectory = np.column_stack([2 * (1 - t), -2 * (1 - t)])

        fig = plot_energy_landscape_2d(
            energy, xlim=(-3, 3), ylim=(-3, 3), trajectory=trajectory, resolution=30, show=False
        )
...
class TestPhaseTransition:
    ...
    def test_basic_phase_transition(self):
        ...
        fig = plot_phase_transition(temperatures, magnetizations, show=False)
    ...
    def test_with_error_bars(self):
        ...
        fig = plot_phase_transition(
            temperatures, magnetizations, magnetization_errors=errors, show=False
        )
    ...
    def test_with_critical_temperature(self):
        ...
        fig = plot_phase_transition(
            temperatures, magnetizations, critical_temp=2.269, show=False
        )
...
class TestSamplingDiagnostics:
    ...
    def test_with_true_distribution(self):
        ...
        fig = plot_sampling_diagnostics(samples, true_distribution=true_dist, show=False)
...
class TestActiveLearningCurve:
    ...
    def test_basic_learning_curve(self):
        ...
        fig = plot_active_learning_curve(n_labeled, acc_active, acc_random, show=False)
    ...
    def test_equal_performance(self):
        ...
        fig = plot_active_learning_curve(n_labeled, acc, acc, show=False)
